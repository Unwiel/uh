...
-- sprites that only load if Low Quality is turned off
  if not lowQuality then 
    ...
    elseif lowQuality then
       makeLuaSprite('dark', 'halloween_bgD3_low_dark', -200, -100)
       makeLuaSprite('ci', 'halloween_bgD3_low', -200, -100)
   end
