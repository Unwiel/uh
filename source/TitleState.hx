...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
        ...
        {
            case 1:
			char = new FlxSprite(400, 30).loadGraphic(Paths.image('gfDanceTitle'));//put your cords and image here
            ...
            case 2:
			char = new FlxSprite(600, 280).loadGraphic(Paths.image('bfDanceTitle'));
